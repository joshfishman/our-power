...
| `indiv24.zip` (11GB itcont.txt)         | itemized individual contributions ≥$200, 2024                         | **LIVE** — LegislatorIndividualMoney (2024 only)        |
| `indiv22.zip` (4.9GB)                   | itemized individual contributions, 2022                               | **ON DISK — not yet ingested**                          |
| `indiv18/20.zip`                        | itemized individual, 2018/2020                                        | **NOT HELD**                                            |
